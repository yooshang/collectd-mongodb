...
CONNECTION_POOL_STATUS_METRICS = {
    ...
    "totalAvailable": "guage",
    'totalCreated': "total_connections",
    'numDBClientConnection': "guage",
    'numAScopedConnection': "guage"
}
...
mongodb = MongoDB()
collectd.register_read(mongodb.publish_connection_pool_metrics)
collectd.register_read(mongodb.publish_dbstats)
collectd.register_read(mongodb.publish_server_status)
